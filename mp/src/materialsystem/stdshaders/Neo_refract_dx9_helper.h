...
#ifndef NEO_REFRACT_DX9_HELPER_H
#define NEO_REFRACT_DX9_HELPER_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
struct Neo_Refract_DX9_Vars_t
{
	Neo_Refract_DX9_Vars_t() { memset(this, 0xFF, sizeof(*this)); }
...
#endif // NEO_REFRACT_DX9_HELPER_H
